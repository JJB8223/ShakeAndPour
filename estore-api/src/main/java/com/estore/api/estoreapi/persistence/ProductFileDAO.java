...
public class ProductFileDAO implements ProductDAO {
    ...
    public ProductFileDAO(@Value("${products.file}") String filename,ObjectMapper objectMapper) throws IOException {
        this.filename = "estore-api/data/products.json"; // For whatever reason this is not working properly on my windows machine, trying to manually set the file path first then do it properly through REST
